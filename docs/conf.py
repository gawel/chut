# -*- coding: utf-8 -*-
#
# chut documentation build configuration file, created by
...
latex_documents = [
  ('index', 'chut.tex', u'chut Documentation',
...
man_pages = [
    ('index', 'chut', u'chut Documentation',
     [u'Gael Pasgrimaud'], 1)
]
...
texinfo_documents = [
  ('index', 'chut', u'chut Documentation',
   u'Gael Pasgrimaud', 'chut', 'One line description of project.',
   'Miscellaneous'),
]
